...
const LibrosPage = () => {
    ...
    return (
        <div className={styles["bg-black"]}>
            <Head>
                <title>Libros</title>
                <meta name="description" content="Libros, descubre las creaciones literarias de Óscar Preciado — Xscriptor" />
                <meta name="keywords" content="literatura, poesía, escritura creativa, frases, textos, filosofía literaria, poemarios, colaterales, cielos de alquitrán, Xscriptor, Óscar Preciado" />
            ...
            >
                <div className={`${styles["relative"]} ${styles["h-full"]}`}>
                    ...
                    <div className={styles["image-wrapper"]}>
                        <Image 
                            src="/images/colecciones/libros/libros01.webp"
                            alt="Colecciones"
                            width={1920}
                            height={1080}
                    ...
                    <div className={`${styles["content-overlay"]} text-center`}>
                        <div className={`${styles["flex"]} ${styles["flex-col"]} ${styles["button-container"]}`}>
                            <Link href="/colecciones/libros/colaterales" passHref>
                            ...
                            <Link href="/colecciones/libros/cielos-de-alquitran" passHref>
                                <button className={styles["button"]} 
                                    style={{ 
                                        filter: `blur(${blurEffect1}) brightness(${brightnessEffect})`
                                    }}>
